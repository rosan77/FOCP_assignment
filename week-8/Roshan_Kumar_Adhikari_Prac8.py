...
#4
name = "Roshan kumar Adhikari"
age = 19.7123
print(f"{name:>20} {age:$>20.2f}")
    # Roshan kumar Adhikari $$$$$$$$$$$$$$$19.71
...
with open(r'C:\Users\ace\Desktop\info.txt', 'a') as file:
    file.write("Roshan kumar Adhikari says hello....\n")
age = 19
with open(r'C:\Users\ace\Desktop\info.txt', 'a') as file:
    file.write(str(age) + "\n")
# This is a text file
# It contains multiple lines of text
# This is the final line within the file
# Roshan kumar Adhikari says hello....
# 19
